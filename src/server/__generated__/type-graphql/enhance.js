...
const outputsInfo = {
    AggregateTodoItem: ["_count", "_min", "_max"],
    TodoItemGroupBy: ["id", "text", "complete", "hidden", "createdAt", "updatedAt", "_count", "_min", "_max"],
...
const inputsInfo = {
    ...
    TodoItemOrderByWithAggregationInput: ["id", "text", "complete", "hidden", "createdAt", "updatedAt", "_count", "_max", "_min"],
    TodoItemScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "text", "complete", "hidden", "createdAt", "updatedAt"],
    TodoItemCreateInput: ["id", "text", "complete", "hidden", "createdAt", "updatedAt"],
    TodoItemUpdateInput: ["id", "text", "complete", "hidden", "createdAt", "updatedAt"],
    TodoItemUpdateManyMutationInput: ["id", "text", "complete", "hidden", "createdAt", "updatedAt"],
